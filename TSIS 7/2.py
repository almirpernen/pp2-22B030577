...
def load_music():
    songs = []
    list_of_music = os.listdir(r'C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\music')
...
pygame.display.set_icon(pygame.image.load(r"C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\icon2.png"))

surf_1 = pygame.Surface((340, 55))

icon_play = pygame.image.load(
    r'C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\1-18309_big-image-media-player-buttons-png (6).png').convert_alpha()
icon_stop = pygame.image.load(
    r'C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\1-18309_big-image-media-player-buttons-png (3).png').convert_alpha()
icon_next = pygame.image.load(
    r'C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\1-18309_big-image-media-player-buttons-png (5).png').convert_alpha()
icon_previous = pygame.image.load(
    r'C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\1-18309_big-image-media-player-buttons-png (4).png').convert_alpha()
juzz_icon = pygame.image.load(r"C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\1200x1200bf-60.jpg").convert()
stan_icon = pygame.image.load(r"C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\s-l1600-4-1.jpg")
loseYorself_icon = pygame.image.load(r"C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\800x800bb.jpg")
Godzila_icon = pygame.image.load(r"C:\Users\Админ\Desktop\pp2python\TSIS 7\2ndtask\image\Eminem.jpg")
...
loseYorself_icon = pygame.transform.scale(loseYorself_icon,
                                          (loseYorself_icon.get_width() // 3.27, loseYorself_icon.get_height() // 3.27))
Godzila_icon = pygame.transform.scale(Godzila_icon,
                                      (Godzila_icon.get_width() // 5.03, Godzila_icon.get_height() // 3.58))
